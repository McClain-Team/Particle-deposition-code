...
baseout = "C:\PURDUE\Year 5 (Graduate)\Research\Experiments\High Speed Camera\IPS Cone Flow Image Processing\AllDataLongExV2\S";
if exframeimout
...
%         break
    ...
    if invheatmapimout
        imwrite(imcomplement(totalim), outputname(i)+"-HI.png"); % png or tiff for binary image out
    end
